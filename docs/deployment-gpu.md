...
## Step 8: Apply EnvoyFilters and NetworkPolicies (2 minutes)
...
**What these do:**
1. **envoyfilter-ext-proc-gpu.yaml** - Fixes ext_proc filter to use Istio mTLS cluster for EPP communication
