...
# Apply Red Hat registry pull secret to kube-system (prerequisite for Istio CNI DaemonSet - Step 4.1 also patches the service account to reference this secret)
